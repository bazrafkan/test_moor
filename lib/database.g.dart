...
class Todo extends DataClass implements Insertable<Todo> {
  ...
  final bool content;
  final int category;
  Todo({@required this.id, @required this.title, this.content, this.category});
  factory Todo.fromData(Map<String, dynamic> data, GeneratedDatabase db,
    ...
    return Todo(
      ...
      content:
          boolType.mapFromDatabaseResponse(data['${effectivePrefix}content']),
      category:
  ...
  factory Todo.fromJson(Map<String, dynamic> json,
    ...
    return Todo(
      ...
      content: serializer.fromJson<bool>(json['content']),
  ...
  Map<String, dynamic> toJson(
    ...
    return {
      ...
      'content': serializer.toJson<bool>(content),
  ...
  Todo copyWith({int id, String title, bool content, int category}) => Todo(
        id: id ?? this.id,
...
class $TodosTable extends Todos with TableInfo<$TodosTable, Todo> {
  ...
  GeneratedBoolColumn _content;
  @override
  GeneratedBoolColumn get content => _content ??= _constructContent();
  GeneratedBoolColumn _constructContent() {
  ...
  Map<String, Variable> entityToSql(TodosCompanion d) {
    ...
    if (d.content.present) {
      map['content'] = Variable<bool, BoolType>(d.content.value);
    }
    if (d.category.present) {
